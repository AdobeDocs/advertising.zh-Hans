...
您可以将自定义目标创建为 *目标* within [!DNL Advertising Search, Social, & Commerce].

要创建自定义目标，DSP帐户必须关联到 [!DNL Search, Social, & Commerce] 帐户中具有相同的Adobe Experience Cloud组织ID [!DNL Search, Social, & Commerce] 客户端设置。 如果您的DSP帐户未关联到 [!DNL Search, Social, & Commerce] 帐户，请联系您的Adobe帐户团队。
