...
| [!UICONTROL Highest ROAS (click focused) - Custom Goal] | （仅在包级别可用）预算分配优先考虑广告支出回报率(ROAS)最高的投放位置，更侧重于基于点击的转化而不是基于展示的转化。<br><br>拍卖评估优先考虑ROAS。 如果支出目标得以实现，则DSP会在降低CPM与提高ROAS之间取得平衡。 | 营销活动类型：性能<br><br>基准：最高收入<br><br>广告类型：显示、原生和视频<br><br>程序包必须已收到至少1000次点击才能开始优化。<br><br><b>注意：</b> 请参阅&quot;[设置效果活动的最佳实践](/help/dsp/optimization/campaign-best-practices-performance.md)”以了解更多信息。 |
...
| [!UICONTROL Lowest CPA (click focused) - Custom Goal] | （仅在包级别可用）预算分配可优先处理具有最低CPA的投放位置，与其说基于展示的转化，不如说基于点击的转化。<br><br>拍卖评估优先考虑CPA。 如果实现了支出目标，则DSP会在降低CPM与降低CPA之间取得平衡。 | 营销活动类型：性能<br><br>基准：最低CPA<br><br>广告类型：显示、原生和视频<br><br>程序包必须已收到至少1000次点击才能开始优化。<br><br><b>注意：</b> 请参阅&quot;[设置效果活动的最佳实践](/help/dsp/optimization/campaign-best-practices-performance.md)”以了解更多信息。 |
