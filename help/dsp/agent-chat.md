...
使用AI聊天界面在[《Advertising DSP Guide》](/help/dsp/home.md)和[《Advertising Guide》](/help/creative/home.md)(有Advertising Creative的广告客户)中搜索概念和Advertising Creative方法。 答案仅基于[Experience League](https://experienceleague.adobe.com/en/docs/advertising)中这些产品的记录内容。

回复包括引文以及其他提示和跟进问题，可帮助您优化查询并查找更多信息。 将保留您的聊天历史记录，不会与其他用户共享您的查询。

>[!NOTE]
>
>查询不会返回有关帐户的数据，如营销活动、交易或受众配置、状态或绩效。 它们也不帮助您解决问题。
...
1. 输入查询，然后单击![提交提示](/help/dsp/assets/submit-prompt.png "提交提示")。

   有关详细信息，请参阅“[编写提示](#writing-prompts)”。

   响应包括内联引用和底部的&#x200B;**[!UICONTROL Documentation Sources]**&#x200B;列表。 还可能会出现跟进问题和建议。

1. （可选）要打开用作数据源的页面，请执行以下操作之一：
...
* **尽可能匹配产品功能（如“营销活动”或“交易”）的UI条款**。

  对于常见操作（如“添加”、“附加”或“分配”），您可以使用同义词。

* **添加细节**&#x200B;以缩小或扩大结果范围。 根据需要通过跟进问题进行细化。
