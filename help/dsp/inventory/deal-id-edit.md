...
1. 编辑[交易设置](deal-id-settings.md)。
   ...
   您无法编辑[!UICONTROL Deal ID]、[!UICONTROL Publisher]、[!UICONTROL SSP]、[!UICONTROL Deal Type]或[!UICONTROL Billing Method]设置。
...
>* [为私人交易指定投放位置和广告](/help/dsp/inventory/deal-id-attach-placements.md)
