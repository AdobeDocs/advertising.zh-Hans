...
供应方平台(SSP)是一个广告技术平台，用于帮助数字媒体所有者和出版商在自动拍卖中销售数字广告。 数字媒体所有者和出版商使用SSP协调、管理其广告库存的供应和分发并使其盈利。 Advertising DSP与所有领先的SSP集成，允许广告商轻松访问高质量库存来满足其广告需求。
...
| [!DNL DailyMotion] |  | [!DNL TubeMogul]或Adobe Advertising | — | 美国+欧洲、中东和非洲 | 美元，欧元 | 显示桌面和移动设备<br><br>视频桌面、移动和CTV |
...
| [!DNL Google Authorized Buyers] （以前为[!DNL Google AdX]） | [!DNL Google] | AdobeNA - 44912714<br>AdobeAPAC和欧盟 — 89185975 | PG支持 | 全球 | 美元、巴西雷亚尔 | 音频桌面和移动设备<br><br>显示桌面和移动设备<br><br>视频桌面、移动和CTV |
...
| [!DNL SmartClip] |  | Adobe Advertising | — | 欧洲、中东和非洲 | 所有货币 | 显示桌面和移动设备<br><br>视频桌面、移动和CTV |
| [!DNL SmartStream] |  | Adobe Advertising | — | 欧洲、中东和非洲 | 欧元，美元 | 视频桌面和移动设备 |
...
| [!DNL TripleLift] |  | [!DNL TubeMogul]或Adobe Advertising | — | 全球 | USD | 本机显示 |
