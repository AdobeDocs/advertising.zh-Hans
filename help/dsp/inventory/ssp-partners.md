...
>[!TIP]
>
>下表是宽的。 如有必要，请使用表格底部的滚动条查看全部内容。 您还可以选择临时隐藏目录或右窗格，方法是单击左窗格顶部的![隐藏左窗格](/help/dsp/assets/hide-left-pane.png "隐藏左窗格")或右窗格顶部的![隐藏右侧窗格](/help/dsp/assets/hide-right-pane.png "隐藏右侧窗格")。

| 列出SSP | 公司 | 座位 ID | 计划性保证支持 | 区域 | 支持的货币 | 视频桌面 | 视频移动设备 | Video TV | 显示桌面 | 显示移动设备 | 本机显示 | 音频桌面和移动设备 |
|--- |--- |--- |--- |--- |--- |--- |--- |--- |--- |--- |--- |--- |
| [!DNL AdColony] （以前为[!DNL Opera]） | [!DNL Digital Turbine] | [!DNL TubeMogul] | 否 | 全局 | 美元 | x | x |  | x | x |  |  |
| [!DNL AdsWizz] | [!DNL Sirius XM (Pandora)] | Adobe Advertising | 是 | 全局 | 美元、欧元、英镑 |  |  |  |  |  |  | x |
| [!DNL AppNexus] | [!DNL Xandr] | 视频名额ID：9094<br>显示名额ID：3939 | 否 | 全局 | 美元 | x | x | x | x | x |  |  |
...
| [!DNL FreeWheel] （以前为[!DNL StickyAds]） | [!DNL Comcast] | [!DNL TubeMogul]或Adobe Advertising | 是 | 全局 | 美元、欧元、澳元、英镑 | x | x | x |  |  |  |  |
| [!DNL Google Authorized Buyers] （以前为[!DNL Google AdX]） | [!DNL Google] | AdobeNA - 44912714<br>AdobeAPAC和EU - 89185975 | 是 | 全局 | 美元，巴西雷亚尔 | x | x | x | x | x |  | x |
| [!DNL GumGum] |  | Adobe Advertising | 否 | 全局 | 美元 | x | x |  | x | x |  | |
| [!DNL Index] | [!DNL Index] | [!DNL Adobe Display]<br>[!DNL Adobe Video] | 否 | 全局 | 美元 | x | x | x | x | x | | |
| [!DNL Magnite (Streaming) CTV] | [!DNL Magnite] （以前为[!DNL Telaria]和[!DNL Tremor]） | [!DNL TubeMogul]或Adobe Advertising | 是 | 全局 | AUD， USD | x | x | x |  |  |  |  |
| [!DNL Magnite DV+] | [!DNL Magnite] （以前为[!DNL Telaria]和[!DNL Tremor]） | [!DNL TubeMogul]或Adobe Advertising | 是 | 全局 | 美元 | x | x | x | x | x |  | x |
...
| [!DNL Teads] |  | [!DNL TubeMogul]或Adobe Advertising | 否 | Outstream Video = Global<br>Display = NA + EMEA | 美元 | x | x |  | x | x |  |  |
