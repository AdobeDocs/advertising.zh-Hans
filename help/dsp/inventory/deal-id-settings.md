...
| 部分 | 参数 | 描述 | 必填 | 可编辑 |
|---------|-----------|-------------|----------|----------|
| [交易详细信息] | [!UICONTROL Deal name] | 在Advertising DSP中标识您的[!UICONTROL Deal ID]的名称。 输入名称或选择&#x200B;**[!UICONTROL Auto-name]**&#x200B;以允许DSP根据交易详细信息生成名称。<br><br>自动生成名称的示例： `[!DNL 24159708 - Deal ID - Guaranteed Fixed - USD - 5 - 24Kitchen - Private]` | 是 | 是 |
