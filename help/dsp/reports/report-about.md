...
* 预配置的报告模板
   ...
   * **[!UICONTROL All-in Cost]**：（仅同时具有Advertising Creative和Advertising DSP的广告商）使用此报表可查看Advertising DSP的广告投放与Adobe Creative的广告投放相关的支出金额。 您可以在促销活动、资源包、版面和广告级别查看创意、属性、目标和其他数据。
