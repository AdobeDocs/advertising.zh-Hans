...
* 当您更改投放位置或资源包设置时，更改何时生效？
  ...
  如果这是交付的最后一天，请在当天早些时候进行更改，以便DSP有充足的时间根据更改重新调整包。 例如，如果您从偶数步调更改为前载步调，DSP需要重新评估如何在剩余的飞行过程中分配支出。 如果在航班的最后一天只剩一小时交付，请不要做出这种改变。

## 中期预算更新

* 对投放位置进行更改后，DSP需要多久才能重新分配包预算？
