...
* CPM的扩展展示次数定价为0.35 USD（仅使用[!DNL LiveRamp]设备图提供的展示次数，而不是在目标受众区段内找到的设备上提供的展示次数）
...
* **包：**&#x200B;您可以选择在包级别设置其他频率上限。 DSP遵循营销活动层级中最严格的频率限制。

* **投放位置：**&#x200B;您可以选择在投放位置级别设置其他频率上限。 DSP遵循营销活动层级中最严格的频率限制。
...
### 设置[!UICONTROL Conversion]跨设备转化归因报表

#### [!UICONTROL Conversion]报告设置
