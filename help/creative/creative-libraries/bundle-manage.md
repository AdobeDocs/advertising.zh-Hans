...
可以将现有标准显示创意附加到标准显示包，将标准视频创意附加到标准视频包，将动态显示创意附加到动态包，将动态视频创意附加到视频包。 将创意内容附加到捆绑包后，创意内容便可在捆绑包所分配到的所有体验中可用。 每个包只能包含每个\[创意大小或持续时间+语言\]组合中的一个。
...
1. 选择包：
   ...
   * 在卡片视图中，单击包名称旁边的&#x200B;**[!UICONTROL ...]**，然后单击&#x200B;**[!UICONTROL Change Log]**。
