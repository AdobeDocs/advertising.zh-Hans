...
| 日期 | 功能 | 描述 | 了解更多信息 |
| ---- | ------- | ----------- | -------------------- |
| 2025年11月17日 | Advertising Creative的成本报表 | (仅使用Advertising Creative的广告商；测试版功能)新的[!UICONTROL All-in Cost BETA]报表显示归因于Adobe Creative的广告服务的支出金额。 报表的支出量度包括[!UICONTROL Billable Creative Spend]、[!UICONTROL Non Billable Creative Spend]、[!UICONTROL Total Creative Spend]、[!UICONTROL Total Creative CPM]和[!UICONTROL Estimated Tax on Creative]。 您可以在促销活动、资源包、版面和广告级别查看创意、属性、目标和其他数据。 |
