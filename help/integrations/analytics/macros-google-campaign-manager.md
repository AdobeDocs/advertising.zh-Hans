...
在DSP中，当您创建包含[!DNL Analytics for Advertising]参数(`amo`)的广告时，`ef_id`和`s_kwcid`宏会自动附加到单击URL。 最佳做法是检查DSP中的标记，以确保`ef_id`和`s_kwcid`宏存在。

以下是DSP中显示的[!DNL Google Campaign Manager 360] [ins标记](https://support.google.com/campaignmanager/answer/6080468)的示例。
