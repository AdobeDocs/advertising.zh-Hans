...
[!DNL Analytics] 在Analytics点击中设置Adobe广告ID(AMO ID)，但受广告商的eVar持久性设置的约束，该设置同时适用于点进和显示到达。 持久性设置在Adobe广告后端配置，您的Adobe帐户团队可以更改该设置。
...
请联系您的Adobe客户团队，以了解每个渠道中最新的受支持广告环境。
