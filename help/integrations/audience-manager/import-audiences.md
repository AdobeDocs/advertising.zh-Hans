...
* 组织必须为Experience Cloud服务[启用](https://experienceleague.adobe.com/en/docs/core-services/interface/services/overview)，并且具有Experience Cloud [!DNL Organization ID]（以前称为[!DNL IMS org ID]）。

  [!UICONTROL Organization ID]允许拥有多个Adobe Experience Cloud产品的组织在某些产品之间共享数据。

* （使用[!DNL Analytics]的广告商）该广告商必须[使用 [!DNL Analytics] `appMeasurement.js`版本1.6.4或更高版本实施](https://experienceleague.adobe.com/en/docs/analytics/implementation/js/overview)。
