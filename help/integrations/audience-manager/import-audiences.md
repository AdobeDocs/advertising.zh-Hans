...
* 组织必须为Experience Cloud服务[&#128279;](https://experienceleague.adobe.com/en/docs/core-services/interface/services/overview)启用并且具有Experience Cloud[!DNL Organization ID]（以前称为[!DNL IMS org ID]）。
