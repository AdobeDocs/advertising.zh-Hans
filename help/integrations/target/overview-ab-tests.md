...
description: 了解如何在 [!DNL Target] 用于您的DSP和 [!DNL Search, Social, & Commerce] 广告。
...
# 在Adobe Target中配置A/B测试以用于Advertising DSP和 [!DNL Advertising Search, Social, & Commerce] 广告
...
请联系您的Adobe客户团队和广告解决方案组(aac-advertising-solutions-group@adobe.com)，以检索所需的版面密钥并完成设置，并确保每个点进URL都填充了版面密钥。
