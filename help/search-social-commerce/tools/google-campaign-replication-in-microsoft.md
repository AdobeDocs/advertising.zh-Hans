...
您可以将同步的营销活动导出到 [!DNL Google Ads] 帐户直接转入已同步 [!DNL Microsoft® Advertising] 将帐户作为增强型CPC (eCPC)活动。 现有竞价和营销活动预算可缩放。 现有的搜索、社交和商务跟踪不会导入。
...
1. 在搜索、社交和商务主菜单中，单击 **[!UICONTROL Search]> [!UICONTROL Tools] >[!UICONTROL Import Campaigns]**.
...
1. （可选）将搜索、社交和商务跟踪添加到中 [帐户](/help/search-social-commerce/campaign-management/accounts/ad-network-account-manage.md)， [营销活动](/help/search-social-commerce/campaign-management/campaigns/campaign-manage.md)， [广告组](/help/search-social-commerce/campaign-management/campaigns/ad-group-manage.md)，或 [广告](/help/search-social-commerce/campaign-management/campaigns/ad-manage.md) 设置。
