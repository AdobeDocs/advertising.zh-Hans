...
* 所有约束都是名为“[”的单个](https://experienceleague.adobe.com/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-about.html)标签分类[!UICONTROL Constraints]的标签值。
