...
[!UICONTROL Scheduled Reports]视图中提供了以下报表类别。 您可能无权访问所有这些报表；可用的报表及其生成的数据取决于您的角色以及客户帐户的配置方式。
...
* 使用[报告模板](/help/search-social-commerce/new-ui/reports/report-templates-manage.md)每天或在一周或一个月中的特定日期自动生成报告。
...
## [!UICONTROL Scheduled Reports]视图

[!UICONTROL Reports] > [!UICONTROL Scheduled Reports]视图允许您创建和管理报表、模板和电子表格馈送。 该视图包含两个选项卡：
