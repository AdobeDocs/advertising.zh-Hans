...
* *[!UICONTROL Manual CPC]*： （品牌的购物营销活动和[!DNL Microsoft Store Ads]营销活动）使用每次点击成本(CPC)模型。 对于某些广告类型，您可以选择允许广告网络更改促销活动的竞价：
...
* *[!UICONTROL Maximize Conversions]：* (搜索网络或受众网络上的效果最佳的促销活动和促销活动（但不包括受众视频或连接的电视）)广告网络（不包括Search、Social和Commerce）可优化竞价以最大限度地提高转化率。 （可选）输入&#x200B;**[!UICONTROL Target CPC]**（每次点击成本）。 对于受众营销活动，您还可以输入可选的&#x200B;**[!UICONTROL Target CPA]**（每次客户获取的成本）。 **注意：**&#x200B;请将此选项用于具有营销活动级别优化的项目组合中的营销活动。 在包含营销活动级优化的组合中， Search、Social和Commerce可优化Target CPA。

* *[!UICONTROL Maximize Conversion Value]：* （搜索和购物/智能购物网络，效果最佳的促销活动）广告网络（而不是Search、Social和Commerce）会优化竞价以最大限度地实现转化价值。 （可选）输入&#x200B;**[!UICONTROL Target Return on Ad Spend]** (ROAS)作为百分比。 **注意：**&#x200B;请将此选项用于具有营销活动级别优化的项目组合中的营销活动。 在包含营销活动级优化的组合中， Search、Social和Commerce可优化Target ROAS。

* *[!UICONTROL Target CPA]：* （搜索网络上的促销活动）广告网络（不是Search、Social和Commerce）基于可选的&#x200B;**[!UICONTROL Target CPA]**（每次客户获取成本）优化竞价，这是您想要为客户获取（转化）支付的30天平均金额。 **注意：**&#x200B;请将此选项用于具有营销活动级别优化的项目组合中的营销活动，以及除[!UICONTROL Weekly]或[!UICONTROL Google Target CPA]之外的任何支出策略。 在包含营销活动级优化的组合中， Search、Social和Commerce可优化Target CPA。

  平均位置和CPC竞价数据不适用于具有此竞价策略的营销活动。

* *[!UICONTROL Target Impression Share]：* （搜索网络上的营销活动）广告网络（而不是Search、Social和Commerce）会优化竞价以实现目标展示份额和广告位置。 （可选）输入&#x200B;**[!UICONTROL Target Impression Share]**&#x200B;作为百分比、**[!UICONTROL Target Ad Position]**&#x200B;和&#x200B;**[!UICONTROL Max CPC]**（每次点击成本）。 **注意：**&#x200B;具有关键词级别优化的项目组合不支持此选项。

* *[!UICONTROL Target Return on Ad Spend]：* （搜索和购物网络上的营销活动）广告网络（而不是Search、Social和Commerce）根据以百分比形式指定的&#x200B;**[!UICONTROL Target ROAS]**（广告支出回报率）优化竞价。 （可选）输入&#x200B;**[!UICONTROL Max CPC]**（每次点击成本）以确保广告网络为每次点击支付的金额不会超过特定金额。 **注意：**&#x200B;请将此选项用于具有营销活动级别优化的项目组合中的营销活动，以及除[!UICONTROL Weekly]或[!UICONTROL Google Target ROAS]之外的任何支出策略。 在包含营销活动级优化的组合中， Search、Social和Commerce可优化Target ROAS。
...
**[!UICONTROL Local Inventory Ads]：** （仅限购物网络营销活动）允许广告网络自动将您的本地库存信息添加到购物广告。

**提示：**&#x200B;如果使用此设置，请勿在[!UICONTROL Inventory Filter]设置中排除本地广告。

**注意：**&#x200B;本地库存广告需要向您的商户中心帐户添加两个馈送 — 一个包含您的本地产品数据，另一个包含您的本地产品库存。 有关[本地购物广告](https://help.ads.microsoft.com/#apex/ads/en/60055)的更多信息，请参阅[!DNL Microsoft Advertising]文档。
