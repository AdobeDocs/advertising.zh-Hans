---
title: （新UI）从[!UICONTROL Ads]视图管理数据视图报告
...
# （新UI）从[!UICONTROL Ads]视图管理数据视图报告

*Beta功能*

您可以生成一个报表，其中包含在[!UICONTROL Ads]视图中的一个或多个广告的数据行，然后以Microsoft Excel工作表文件（XLXS格式）的形式下载该报表。 报告包含视图中的所有可见列。
...
>[!MORELIKETHIS]
>
>* [关于[!UICONTROL Ads view]](ad-view-about.md)
