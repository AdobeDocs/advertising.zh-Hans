---
title: （新UI）关于[!UICONTROL Ads]视图
description: 了解您可以在[!UICONTROL Ads]视图中执行的操作。
...
* [从[!UICONTROL Ads]视图管理数据视图报告](ad-view-report.md)

* [更改广告的状态](ad-change-status.md)
<!--
...
>[!MORELIKETHIS]
>
>* [（新UI）从[!UICONTROL Ads]视图](ad-view-report.md)管理数据视图报告
