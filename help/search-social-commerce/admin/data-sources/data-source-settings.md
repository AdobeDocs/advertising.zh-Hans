...
|  | [!UICONTROL Google Analytics Dimension] | 此 [!DNL Google Analytics] 使用Adobe广告“ef_id”查询字符串参数的值填充的自定义维度。 如果列出的维度不正确，请联系贵机构的 [!DNL Google Analytics] 实施团队。<br><br>“ef_id”用作从中传递数据的主键 [!DNL Google Analytics] Adobe广告。 |
