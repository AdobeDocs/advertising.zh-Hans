...
user-guide-description: 了解Advertising Search、Social和Commerce的最新更新和新增功能。
...
+ 常见任务 {#common-tasks}
   ...
   + 自定义数据视图 {#data-views}
      ...
      + 临时视图设置 {#ad-hoc-settings}
         ...
         + [编辑列集并对列集进行排序 [!UICONTROL Custom Columns] 图标](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
   ...
   + 点击跟踪 {#click-tracking}
      ...
      + 点击跟踪URL的组件 {#click-tracking-components}
         + 点击跟踪URL的标准格式 {#click-tracking-formats}
            ...
            + [的点击跟踪格式 [!DNL Baidu]](/help/search-social-commerce/tracking/formats-click-tracking-baidu.md)
            + [的点击跟踪格式 [!DNL Google Ads]](/help/search-social-commerce/tracking/formats-click-tracking-google.md)
            + [的点击跟踪格式 [!DNL Microsoft Advertising]](/help/search-social-commerce/tracking/formats-click-tracking-microsoft.md)
            + [的点击跟踪格式 [!DNL Naver]](/help/search-social-commerce/tracking/formats-click-tracking-naver.md)
            + [的点击跟踪格式 [!DNL Yahoo! Display Network]](/help/search-social-commerce/tracking/formats-click-tracking-yahoo-display-network.md)
...
+ 营销活动管理 {#campaign-management}
   ...
   + 设置帐户 {#campaign-management-accounts}
      + 广告网络帐户 {#ad-network-accounts}
         ...
         + [更新的s\_kwcid跟踪代码 [!DNL Google Ads] 帐户](/help/search-social-commerce/campaign-management/accounts/update-skwcid-google.md)
   ...
   + 管理活动 {#management}
      ...
      + 在中管理数据 [!UICONTROL Campaigns] > [!UICONTROL Campaigns] 查看次数 {#campaigns}
         ...
         + 关键字 {#keywords}
            ...
            + 按广告网络列出的关键词设置 {#keyword-settings-by-network}
               ...
               + [[!DNL Yahoo! Japan Ads] 关键词设置](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yahoo-japan.md)
               + [[!DNL Yandex] 关键词设置](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yandex.md)
         + 广告 {#ads}
            ...
            + 按广告网络划分的广告设置 {#ad-settings-by-network}
               ...
               + [[!DNL Microsoft Advertising] 响应式（受众）广告设置](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-responsive.md)
      ...
      + 通过批量工作表管理批量数据 {#bulksheets}
         ...
         + 批量处理工作表中的必需/包含数据{#bulksheet-data-formats}
            ...
            + [以下项的必需批量处理工作表数据 [!DNL Naver] 帐户](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-naver.md)
   ...
   + 报告 {#reports}
      ...
      + 自动化报告 {#report-automation}
         ...
         + 电子表格馈送 {#spreadsheet-feeds}
            ...
            + [创建 [!DNL Excel] 电子表格报表馈送模板](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create-excel-template.md)
...
+ 管理 {#admin}
   ...
   + 配置数据源 {#data-sources}
      ...
      + [配置的前提条件 [!DNL Google Analytics] 数据源](/help/search-social-commerce/admin/data-sources/data-source-prerequisites.md)
      + [配置 [!DNL Google Analytics] 作为数据源查看](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
      + [编辑 [!DNL Google Analytics] 数据源](/help/search-social-commerce/admin/data-sources/data-source-edit.md)
