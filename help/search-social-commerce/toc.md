---
role: User
user-guide-title: Advertising 搜索、社交和 Commerce 指南
...
+ [关于本指南](help-about.md)
+ 简介 {#intro}
   + [关于Adobe Advertising Search、Social和Commerce](/help/search-social-commerce/introduction/about.md)
   + [支持的清单](/help/search-social-commerce/introduction/supported-inventory.md)
   + 与Adobe CX Enterprise集成 {#integrations}
...
+ 常见任务 {#common-tasks}
   ...
   + 自定义数据视图 {#data-views}
      + [关于自定义营销活动管理视图中的数据](/help/search-social-commerce/common-tasks/data-views/data-views-about.md)
      + [管理默认视图和自定义视图](/help/search-social-commerce/common-tasks/data-views/custom-default-views-manage.md)
      + 临时视图设置 {#ad-hoc-settings}
         + [从列标题菜单中编辑列集](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-column-heading.md)
         + [从[!UICONTROL Custom Columns]图标编辑列集并对列集进行排序](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
         + [在营销活动视图中锁定和解锁列配置](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-lock-unlock.md)
...
+ (Beta)新用户界面 {#new-ui}
   ...
   + 管理 {#manage}
      + 项目组合 {#portfolios}
         ...
         + [管理项目组合组](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-group-manage.md)
         + [创建项目组合](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-create.md)
         + [复制项目组合](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-duplicate.md)
         + [编辑项目组合详细信息](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-edit.md)
         + [使用批量工作表文件批量编辑项目组合设置](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-bulksheets.md)
         + [重命名项目组合](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-rename.md)
         + [更改项目组合的状态](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-change-status.md)
         + [Portfolio设置](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-settings.md)
         + [从[!UICONTROL Portfolios]视图运行自定义模拟](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-create-simulation.md)
         + [在[!UICONTROL Portfolios]视图中查看性能图](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-view-performance-graph.md)
   ...
   + 报告 {#reports}
      + 标签分类 {#label-classifications}
         + [关于标签分类](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-about)
         + [创建标签分类](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-create)
         + [从营销活动管理视图将分类值分配给帐户组件](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management)
         + [使用批量处理工作表将分类值分配给帐户组件](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets)
         + [从帐户组件中删除标签分类值](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-remove)
         + [删除标签分类值](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-delete)
         + [删除标签分类](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-delete)
   + Target {#target}
      + 关键字 {#keywords}
...
+ 跟踪 {#tracking}
   ...
   + 转化跟踪 {#conversion-tracking}
      ...
      + Adobe Advertising转化跟踪 {#advertising-conversion-tracking}
         ...
         + [生成和实施Adobe Advertising转换标记](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/tools/tracking/conversion-tag-generate)
         ...
         + [Adobe Advertising JavaScript转化映射标记](/help/search-social-commerce/tracking/itp-conversion-mapping-tag.md)
...
+ 营销活动管理 {#campaign-management}
   + 简介 {#campaign-management-intro}
      ...
      + [搜索、社交和Commerce中的[!DNL Microsoft Advertising]转化数据](/help/search-social-commerce/campaign-management/introduction/microsoft-conversion-data.md)
   + 设置帐户 {#campaign-management-accounts}
      + 广告网络帐户 {#ad-network-accounts}
         ...
         + [更新 [!DNL Google Ads] 帐户的AMO ID跟踪代码](/help/search-social-commerce/campaign-management/accounts/update-amo-id-google.md)
      + [管理商户中心帐户](/help/search-social-commerce/campaign-management/accounts/merchant-account-manage.md)
   ...
   + 管理活动 {#management}
      ...
      + 管理[!UICONTROL Campaigns] > [!UICONTROL Campaigns]视图中的数据 {#campaigns}
         ...
         + 广告 {#ads}
            ...
            + 按广告网络划分的广告设置 {#ad-settings-by-network}
               ...
               + [[!DNL Microsoft Advertising]多媒体广告设置](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-multimedia.md)
               + [[!DNL Microsoft Advertising]产品广告设置](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-product.md)
               + [[!DNL Microsoft Advertising]个响应式（受众）广告设置](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-responsive.md)
               + [[!DNL Microsoft Advertising]响应式搜索广告设置](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-rsa.md)
               + [[!DNL Yandex]文本广告设置](/help/search-social-commerce/campaign-management/campaigns/ad-settings-yandex-text.md)
         + 产品组 {#product-groups}
         ...
         + 广告扩展 {#ad-extensions}
            + [!DNL Google Ads]标注扩展 {#callouts}
               ...
               + [将 [!DNL Google Ads] 共享的标注扩展与营销活动或广告组关联](/help/search-social-commerce/campaign-management/campaigns/callout-extension-associate.md)
            + 站点链接扩展 {#sitelinks}
      ...
      + 通过批量工作表管理批量数据 {#bulksheets}
         ...
         + [验证批量处理工作表文件中的登陆页面](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-validate-landing-pages.md)
      ...
      + 使用库存信息源自动生成Campaign数据 {#inventory-feeds}
         ...
         + 模板 {#feed-templates}
            ...
            + [文本广告和响应式搜索广告模板设置](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-text-rsa.md)
      ...
      + 使用独特工作流实施营销活动、广告和转化{#special-workflows}
         + [为潜在客户实施 [!DNL Google Ads] 增强型转化](/help/search-social-commerce/campaign-management/special-workflows/google-enhanced-conversions-leads.md)
   ...
   + 管理标签分类 {#label-classifications}
      + [关于标签分类](/help/search-social-commerce/campaign-management/label-classifications/classification-about.md)
      + [创建标签分类](/help/search-social-commerce/campaign-management/label-classifications/classification-create.md)
      + [从营销活动管理视图将分类值分配给帐户组件](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management.md)
      + [使用批量处理工作表将分类值分配给帐户组件](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets.md)
...
+ 见解和报表 {#insights-reports}
   + Advertising Insights {#insights}
      ...
      + [生成 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-generate.md)
      + [查看或保存 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-view-save.md)
      + [删除 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-delete.md)
   + 报告 {#reports}
      + [关于报告](/help/search-social-commerce/reports/report-about.md)
      + [报告的初始设置任务](/help/search-social-commerce/reports/initial-setup.md)
      + [用于报表的数据](/help/search-social-commerce/reports/data-used-for-reports.md)
      + 管理报告 {#report-management}
         ...
         + 协助报表 {#assist-reports}
            ...
            + [协助报表设置](/help/search-social-commerce/reports/management/assist/assist-report-settings.md)
      ...
      + 自动化报告 {#report-automation}
         + 报表模板 {#report-templates}
            + [关于报告模板](/help/search-social-commerce/reports/automation/templates/template-about.md)
            + [查看报表模板](/help/search-social-commerce/reports/automation/templates/template-view.md)
            + [创建报表模板](/help/search-social-commerce/reports/automation/templates/template-create.md)
            + [编辑报告模板](/help/search-social-commerce/reports/automation/templates/template-edit.md)
            + [删除报表模板](/help/search-social-commerce/reports/automation/templates/template-delete.md)
         + 电子表格馈送 {#spreadsheet-feeds}
            + [关于电子表格报表源](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-about.md)
            + [为电子表格报表源创建 [!DNL Excel] 模板](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create-excel-template.md)
            + [创建电子表格报表源](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create.md)
            + [编辑电子表格报表馈送设置](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-edit.md)
            + [手动刷新电子表格报表馈送](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-refresh.md)
            + [查看或保存电子表格报表源文件](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-view-or-save.md)
            + [删除电子表格报表源](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-delete.md)
   ...
   + 通知 {#notifications}
      ...
      + [启用和禁用来自[!UICONTROL Notification Center]的推送通知](/help/search-social-commerce/notifications/notifications-push-enable-disable.md)
   ...
   + 自定义警报 {#alerts}
      ...
      + 警报模板 {#alert-templates}
         + [创建自定义警报模板](/help/search-social-commerce/alerts/alert-template-create.md)
         + [编辑自定义警报模板](/help/search-social-commerce/alerts/alert-template-edit.md)
         + [暂停自定义警报模板](/help/search-social-commerce/alerts/alert-template-pause.md)
         + [激活自定义警报模板](/help/search-social-commerce/alerts/alert-template-activate.md)
         + [删除自定义警报模板](/help/search-social-commerce/alerts/alert-template-delete.md)
...
+ 工具 {#tools}
   ...
   + 用于创建和解码跟踪标记的工具{#tracking}
      ...
      + [生成和实施Adobe Advertising转换标记](/help/search-social-commerce/tools/conversion-tag-generate.md)
...
+ 管理 {#admin}
   ...
   + [同步 [!DNL Adobe] 受众](/help/search-social-commerce/admin/sync-adobe-audiences.md)
   + 配置数据源 {#data-sources}
      + [关于同步 [!DNL Google Analytics] 转化量度](/help/search-social-commerce/admin/data-sources/data-source-about.md)
      + [配置 [!DNL Google Analytics] 数据源的先决条件](/help/search-social-commerce/admin/data-sources/data-source-prerequisites.md)
      + [将 [!DNL Google Analytics] 视图配置为数据源](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
      + [编辑a [!DNL Google Analytics] 数据源](/help/search-social-commerce/admin/data-sources/data-source-edit.md)
      + [暂停数据源同步](/help/search-social-commerce/admin/data-sources/data-source-pause.md)
      + [重新验证a [!DNL Google Analytics] 数据源](/help/search-social-commerce/admin/data-sources/data-source-reauthenticate.md)
      + [[!DNL Google Analytics]数据源设置](/help/search-social-commerce/admin/data-sources/data-source-settings.md)
      + [附录 — 可用 [!DNL Google Analytics] 指标](/help/search-social-commerce/admin/data-sources/data-source-ga-metrics.md)
   + 管理广告商的转化量度{#conversion-metrics}
      ...
      + 管理特定于广告网络的转化标记和转化操作/目标 {#network-conversions}
