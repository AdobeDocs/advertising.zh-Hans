...
+ 营销活动管理{#campaign-management}
   ...
   + 管理营销活动{#management}
      ...
      + 使用独特的工作流实施营销活动、广告和转化{#special-workflows}
...
+ 分析和报告{#insights-reports}
   ...
   + 报告 {#reports}
      ...
      + 管理报告{#report-management}
         ...
         + 模型准确性报告{#model-accuracy-reports}
   ...
   + Recommendations和发布者分析{#recommendations}
