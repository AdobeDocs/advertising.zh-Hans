...
+ 简介 {#intro}
  ...
  + [策略和指南（链接）](https://experienceleague.adobe.com/en/docs/advertising/policies/ad-requirements-policy){target="_blank"}
  ...
  + 报告 {#reports}
    + 计划报表 {#scheduled}
      ...
      + 计划报表类型 {#report-types}
        ...
        + 协助报表 {#assist-reports}
          + [关于协助报告](/help/search-social-commerce/new-ui/reports/management/assist/assist-report-about.md)
