...
+ (Beta)新用户界面 {#new-ui}
   ...
   + 计划 {#plan}
      + 目标 {#objectives}
         + [关于目标](/help/search-social-commerce/new-ui/plan/objectives/objective-about.md)
         + [创建目标](/help/search-social-commerce/new-ui/plan/objectives/objective-create.md)
         + [编辑目标](/help/search-social-commerce/new-ui/plan/objectives/objective-edit.md)
         + [删除目标](/help/search-social-commerce/new-ui/plan/objectives/objective-delete.md)
         + [将权重推荐应用于目标](/help/search-social-commerce/new-ui/plan/objectives/objective-apply-weight-recommendations.md)
         + [目标设置](/help/search-social-commerce/new-ui/plan/objectives/objective-settings.md)
      + 模拟 {#simulations}
