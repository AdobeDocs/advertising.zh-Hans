...
description: 了解 [!UICONTROL Portfolio Report].
...
此 [!UICONTROL Portfolio Report] 包括一个或多个项目组合的成本、点击次数和（可选）转化数据。 默认情况下，指定日期范围内每个时间单位的每个适用项目组合的数据都包含一行，这些行首先按项目组合，然后按时间单位的开始日期以升序排列。
