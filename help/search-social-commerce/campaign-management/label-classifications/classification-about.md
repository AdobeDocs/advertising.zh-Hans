...
每个标签分类最多可以具有2000个值。 为分类创建特定标签值后，您可以使用批量处理工作表[从促销活动管理视图](classification-values-assign-campaign-management.md)或[将标签值分配给促销活动、广告组、关键字、广告、投放位置和产品组](classification-values-assign-bulksheets.md)。
