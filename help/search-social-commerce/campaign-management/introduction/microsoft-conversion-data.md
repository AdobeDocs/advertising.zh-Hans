...
搜索、社交和商务会自动同步您跟踪的所有转化 [[!DNL Microsoft® Advertising] 通用事件跟踪(UET)标记](https://about.ads.microsoft.com/solutions/tools/universal-event-tracking) 用于网站转化（包括浏览转化率），以及报表和优化。
